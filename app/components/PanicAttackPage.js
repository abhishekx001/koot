...
const PanicAttackPage = () => {
  const scrollToPanicAttackOverview = () => {
    const element = document.getElementById('what-is-panic-attacks');
    if (element) {
        ...
        <div className="bg-green-50 rounded-3xl p-6 md:p-20 lg:p-24 border border-green-100 relative overflow-hidden">
          ...
          <div className="max-w-4xl pt-6 md:pt-0">
            <h1 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-3 md:mb-4 leading-tight md:leading-relaxed" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>
              Best online counseling in Malayalam<br />
              <span className="text-black">for panic attack Treatment</span>
            </h1>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-64 mb-4 md:mb-6">
              <p className="text-sm text-black leading-relaxed md:leading-loose flex-1 max-w-md" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>
                Panic attacks are sudden episodes of intense fear that trigger severe physical reactions. Koott offers online counseling in Malayalam for panic attacks, with Malayali psychologists providing private and supportive care to help you overcome panic attacks and regain your mental well-being.
                <span 
                  className="text-green-600 cursor-pointer hover:underline" 
                  onClick={scrollToPanicAttackOverview}
                >
                  ...read more
                </span>
              </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 mb-4 md:mb-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-lg font-bold text-gray-800" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>800+</div>
                  <div className="text-xs text-gray-600" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>Lives Changed</div>
                </div>
                {/* Image - Mobile Only, right of 800+ */}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-lg font-bold text-gray-800" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>95%</div>
                  <div className="text-xs text-gray-600" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>Recovery Rate</div>
                </div>
              </div>
            </div>
...
export default PanicAttackPage;