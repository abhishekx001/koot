...
const PostpartumPage = () => {
  const scrollToPostpartumOverview = () => {
    const element = document.getElementById('what-is-postpartum');
    if (element) {
        ...
        <div className="bg-green-50 rounded-3xl p-6 md:p-20 lg:p-24 border border-green-100 relative overflow-hidden">
          ...
          <div className="max-w-4xl pt-6 md:pt-0">
            <h1 className="text-lg md:text-xl lg:text-2xl font-bold text-black mb-3 md:mb-4 leading-tight md:leading-relaxed" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>
              ...
              <span className="text-black">for Postpartum Depression Treatment</span>
            </h1>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-64 mb-4 md:mb-6">
              <p className="text-sm text-black leading-relaxed md:leading-loose flex-1 max-w-md" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>
                Postpartum depression is a serious mental health condition that affects many new mothers after childbirth. Koott offers online counseling in Malayalam for postpartum depression, with Malayali psychologists providing private and supportive care to help you navigate this challenging time and regain your emotional well-being.
                <span 
                  className="text-green-600 cursor-pointer hover:underline" 
                  onClick={scrollToPostpartumOverview}
                >
                  ...read more
                </span>
              </p>
              ...
              <div className="w-24 h-24 md:w-28 md:h-28 flex-shrink-0 hidden md:block">
                <img 
                  src="/personimg.png" 
                  alt="Postpartum Depression Counseling" 
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 mb-4 md:mb-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-lg font-bold text-gray-800" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>600+</div>
                  <div className="text-xs text-gray-600" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>Mothers Helped</div>
                </div>
                {/* Image - Mobile Only, right of 600+ */}
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-lg font-bold text-gray-800" style={{fontFamily: 'var(--font-quicksand), sans-serif'}}>98%</div>
